# Example Seed Paper: Vision-Language Robots

> Status: draft template. Do not mark as `deep_read` until evidence, figures, and conclusions are filled.

## Metadata

- Paper ID: `seed:example-seed-paper-vision-language-robots`
- Source: `seed`
- Priority / Score: `P0` / `25.5`
- Authors: N/A
- Published: 2024
- URL: https://arxiv.org/
- PDF: N/A
- Topics: VLA, Robot Foundation Model, Manipulation
